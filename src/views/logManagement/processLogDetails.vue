        ...
        <div v-show="distlx==1" class="box">
            <div class="czq">
                 <el-row class="topform">
                    ...
                    <hr>
                    <editstart :editList="editList_start"></editstart>     
                </el-row>
            </div>
            <div class="czh">
                <el-row class="topform">
                    ...
                    <hr>
                    <detxmgk-new :xmgkList="editList_end"></detxmgk-new> 
                </el-row>
            </div>
        </div>
...
import detxmgkNew from "./processLogNew";
const editstart = ()=> import("./processLogOld");
export default {
    components: {
        detxmgkNew,
        editstart
