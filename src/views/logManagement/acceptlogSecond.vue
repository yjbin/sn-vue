    ...
    <div class="logsecond">
        ...
        <div v-show="distlx==0" class="box">
            <el-row class="topform">
                ...
                <hr>
                <accept-two :acceptList="addList"></accept-two> 
            </el-row>
        </div>
        <div v-show="distlx==1" class="box">
            <div class="czq">
                 <el-row class="topform">
                    ...
                    <hr>
                    <accept-one :editList="editList_start"></accept-one>     
                </el-row>
            </div>
            <div class="czh">
                <el-row class="topform">
                    ...
                    <hr>
                    <accept-two :acceptList="editList_end"></accept-two> 
                </el-row>
            </div>
        </div>
        <div v-show="distlx==2" class="box">
              <el-row class="topform">
                ...
                <hr>
                <accept-two :acceptList="delFrom"></accept-two> 
            </el-row>
        </div>
...
import acceptOne from "./acceptdet_one";
const acceptTwo = ()=> import("./acceptdet_two");
export default {
    components: {
        acceptOne,
        acceptTwo
