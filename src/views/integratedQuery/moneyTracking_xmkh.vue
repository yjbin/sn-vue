        ...
        <el-row>
          ...
          <el-col :span="9" :offset="2">
            <el-form-item label="录入时间">
              <el-date-picker type="datetime" value-format="timestamp" v-model="xmkhFrom.lrsj" placeholder="录入时间" :disabled="true" style="width:100%"></el-date-picker>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          ...
          <el-col :span="9" :offset="2">
            <el-form-item label="考核时间">
              <el-date-picker type="datetime" value-format="timestamp" v-model="xmkhFrom.khsj" placeholder="考核时间" disabled></el-date-picker>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
