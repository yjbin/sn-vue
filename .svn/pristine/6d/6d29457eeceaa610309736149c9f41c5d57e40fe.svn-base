<template>
    <div class="detailsXmgk">
        <el-form :inline="true" class="demo-form-inline" :model="xmForm" label-width="80px">
            <el-row>
            ...
            <el-row>
                <el-col :span="22" :offset="1">
                    <el-form-item label="项目地址" prop="xmdz" class="w90">
                        <el-input v-model="xmForm.xmdz" placeholder="项目地址" auto-complete='xmdz'></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-col :span="22" :offset="1">
                <el-form-item label="项目GPS" prop="xmGps" class="w90">
            ...
            <el-row>
                <el-col :span="22" :offset="1">
                    <el-form-item label="建设内容" prop="jsnr" class="w90">
            ...
            <el-row>
                <el-col :span="11" :offset="1">
                    <el-form-item prop="xzqh">
                        <el-button type="primary">管理科室</el-button>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
